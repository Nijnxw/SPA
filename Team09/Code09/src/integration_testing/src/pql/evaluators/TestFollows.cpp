...
TEST_CASE("Follows Relationship API") {
	...
	SECTION("Initialization of program variables") {
		...
		SECTION("Follows(1, 2) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("1", "2", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(2, 3) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("2", "3", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(4, 5) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("4", "5", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(1, 3) negative query") {
			QueryClauseTable res = followsEvaluator.getFollows("1", "3", EntityType::INT, EntityType::INT, false);
		...
		SECTION("FollowsT(2, 3) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("2", "3", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(4, 5) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("4", "5", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(1, 3) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("1", "3", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(1, 4) negative query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("1", "4", EntityType::INT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("Follows(3, s) negative query") {
			QueryClauseTable res = followsEvaluator.getFollows("3", "s", EntityType::INT, EntityType::STMT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("FollowsT(3, s) negative query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("3", "s", EntityType::INT, EntityType::STMT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("Follows(2, _) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("2", "_", EntityType::INT, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(4, _) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("4", "_", EntityType::INT, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(3, _) negative query") {
			QueryClauseTable res = followsEvaluator.getFollows("3", "_", EntityType::INT, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("FollowsT(2, _) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("2", "_", EntityType::INT, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(4, _) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("4", "_", EntityType::INT, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(3, _) negative query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("3", "_", EntityType::INT, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("Follows(s, 1) negative query") {
			QueryClauseTable res = followsEvaluator.getFollows("s", "1", EntityType::STMT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("FollowsT(s, 1) negative query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("s", "1", EntityType::STMT, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("Follows(_, 3) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("_", "3", EntityType::WILD, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(_, 5) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("_", "5", EntityType::WILD, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("Follows(_, 1) negative query") {
			QueryClauseTable res = followsEvaluator.getFollows("_", "1", EntityType::WILD, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("FollowsT(_, 3) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("_", "3", EntityType::WILD, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(_, 5) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("_", "5", EntityType::WILD, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		SECTION("FollowsT(_, 1) negative query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("_", "1", EntityType::WILD, EntityType::INT, false);
			REQUIRE(res.getBooleanResult() == false);
		}
		...
		SECTION("Follows(_, _) positive query") {
			QueryClauseTable res = followsEvaluator.getFollows("_", "_", EntityType::WILD, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == true);
		}

		// getFollowsT(LHS wild, RHS wild)
		SECTION("FollowsT(_, _) positive query") {
			QueryClauseTable res = followsEvaluator.getFollowsT("_", "_", EntityType::WILD, EntityType::WILD, false);
			REQUIRE(res.getBooleanResult() == true);
		}
	}
	PKB::clearAllStores();
