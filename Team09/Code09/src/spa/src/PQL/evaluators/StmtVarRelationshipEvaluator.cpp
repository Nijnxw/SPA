...
QueryClauseResult
StmtVarRelationshipEvaluator::getRelationship(RelationRef relationship, const std::string& LHS, const std::string& RHS,
											  EntityType LHSType, EntityType RHSType, bool isBooleanResult) {
...
QueryClauseResult StmtVarRelationshipEvaluator::getRelationshipByUnderscore(
	...
	const std::unordered_set<int>& relationshipStmts = (relationship == RelationRef::MODIFIES)
	...
	switch (LHSType) {
		...
		case EntityType::ASSIGN: {
			const std::unordered_set<int>& assignStmts = PKB::getStatementsWithType(EntityType::ASSIGN);
...
QueryClauseResult
StmtVarRelationshipEvaluator::getRelationshipByVariable(RelationRef relationship, const std::string& LHS,
	...
	switch (LHSType) {
		...
		case EntityType::PRINT:
			queryResult.addColumn(LHS,
								  PKBUtils::unorderedSetIntersection(relationshipStmts,
...
QueryClauseResult
StmtVarRelationshipEvaluator::getRelationshipBySynonym(RelationRef relationship, const std::string& LHS,
													   const std::string& RHS, EntityType LHSType) {
	QueryClauseResult queryResult;
	...
	switch (LHSType) {
		...
		case EntityType::PROC: {
			const auto&[procs, vars] = (relationship == RelationRef::MODIFIES)
