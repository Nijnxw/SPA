...
protected:
	QueryClauseResult
	getRelationshipByStatementNumber(RelationRef relationship, const std::string& LHS, const std::string& RHS,
									 EntityType RHSType);
	QueryClauseResult
	getRelationshipByStatementVariable(RelationRef relationship, const std::string& LHS, const std::string& RHS,
	...
	std::unordered_set<int> filterStatementsByType(const std::unordered_set<int>& statements, EntityType type);
	std::tuple<std::vector<int>, std::vector<int>> filterStatementPairsByType(const std::vector<int>& firstEntities,
																			  const std::vector<int>& secondEntities,
																			  EntityType LHSType, EntityType RHSType);
